...
parser.add_argument('--input1', help='Path to the first input image.', default='img0.png')
parser.add_argument('--input2', help='Path to the second input image.', default='img2.png')
