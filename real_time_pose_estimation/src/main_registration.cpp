...
int main(int argc, char *argv[])
{
    ...
    string img_path = samples::findFile("../Data/box_credentials.JPG");  // image to register
    string ply_read_path = samples::findFile("../Data/credentials_box.ply");          // object mesh
    string write_path = samples::findFile("../Data/box_credentials_cookies_ORB.yml");     // output file
